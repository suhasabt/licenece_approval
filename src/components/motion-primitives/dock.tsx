    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'absolute -top-8 left-1/2 w-fit whitespace-pre rounded-md bg-slate-900 px-2.5 py-1 text-xs font-medium text-white shadow-md dark:bg-white dark:text-slate-900',
            className
          )}
          role='tooltip'
          style={{ x: '-50%' }}
